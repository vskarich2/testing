...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        embedding_mapping = self.embeddings[w]
        x = embedding_mapping.view(batch_size, -1)
    ...
    def forward(self, w):
        ...
        batch = self.embedding_lookup(w)

        linear = batch @ self.embed_to_hidden_weight + self.embed_to_hidden_bias
        h = F.relu(linear)
